...
//$upload_path = substr($_SERVER['PHP_SELF'],0,strripos($_SERVER['PHP_SELF'], '/')+1);
//---------------------------------------------------------------------------------------------
...
//文件保存目录路径
$save_path = $php_path . '/upload/';//默认为 update.php所在目录
//文件保存目录URL
$save_url = $php_url . '/upload/';//默认为 update.php所在目录
//定义允许上传的文件扩展名
$ext_arr = array('gif', 'jpg', 'jpeg', 'png', 'bmp');
//最大文件大小
$max_size = 1024*2000;//(默认500K)
